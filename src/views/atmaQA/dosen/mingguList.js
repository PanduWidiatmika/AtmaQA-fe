...
const MingguList = () => {
    ...
    const updateStatus = (id) => {
        swal({
            title: "Warning",
            text: "Do You Want To Update This Class's Status?",
            icon: "warning",
            buttons: true,
            dangerMode: true,
        })
                                                            ...
                                                            <td>
                                                                ...
                                                                >
                                                                    <CLink
                                                                        ...
                                                                        to={{ pathname: `/lecturer-class/lecturer-class-list/class-detail/${item.id}/${item.week}` }}>
                                                                        <CIcon content={freeSet.cilNewspaper} />
                                                                    </CLink>
                                                                </CTooltip>
                                                                <CTooltip
                                                                    content="Update Class Status"
                                                                    placement="top"
                                                                >
                                                                    <CLink
                                                                        className="card-header-action">
                                                                        <CIcon content={freeSet.cilReload}
                                                                            onClick={(event) => updateStatus(item.week)}
                                                                        />
                                                                    </CLink>
                                                                </CTooltip>
                                                            </td>
