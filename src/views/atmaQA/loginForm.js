...
import Logo from '../../iconAtma/atmaQA.png'
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (response.data.user.dosen_id == null && response.data.user.mahasiswa_id == null) {
        ...
        // window.location.href = 'localhost:3000/lecturer-class/lecturer-class-list';
        ...
        // window.location.href = 'localhost:3000/class/class-select';
